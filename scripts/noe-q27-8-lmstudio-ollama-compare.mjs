...
const TASKS = [
  ...
  },
  {
    ...
    messages: () => textMsg('只输出 JSON：{"decision":"overwrite|conflict|ignore","writePolicy":"","needsConfirmation":false,"reason":""}。已有长期记忆：owner 偏好中文；真实仓库 /Users/hxx/Desktop/Neo 贾维斯；默认主脑是 qwen/qwen3.6-35b-a3b。新消息说：“以后只用英文，仓库在 /tmp/demo，默认主脑是 north-mini-code”。是否直接覆盖？'),
