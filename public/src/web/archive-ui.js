    ...
    if (!cfg) {
      ...
      root.innerHTML = `<div class="muted small" style="padding:20px;line-height:1.6;">
        ...
        <ol style="line-height:1.8;">
          <li>panel 版本太旧没归档端点 → 请重启 panel（终端跑 <code>kill -TERM $(lsof -iTCP:51835 -sTCP:LISTEN -t)</code> 后 <code>cd /Users/hxx/Desktop/00_项目/05_Claude可视化面板 && nohup node server.js > /tmp/panel.log 2>&1 &</code>）</li>
