...
(function () {
  const DICT = {
    ...
    'Neo 贾维斯': 'Neo JARVIS',
    // ── 欢迎页 ──
    '欢迎使用 Noe': 'Welcome to Neo JARVIS',
    '欢迎使用 Neo 贾维斯': 'Welcome to Neo JARVIS',
    '激活 Neo 贾维斯 Pro': 'Activate Neo JARVIS Pro',
    ...
    '对 Noe 说点什么…': 'Say something to Neo JARVIS…',
    '对 Neo 贾维斯说点什么…': 'Say something to Neo JARVIS…',
    ...
    '多 AI 房间': 'Multi-AI Rooms',
    'Noe Brain 仪表盘': 'Neo JARVIS · Noe Runtime Dashboard',
    'Neo 贾维斯 · Noe Runtime 仪表盘': 'Neo JARVIS · Noe Runtime Dashboard',
