...
npm test
git diff --check
HOME=/tmp/noe-e2e-52103 PORT=52103 npm start
HOME=/tmp/noe-e2e-52103 PLAYWRIGHT_BROWSERS_PATH=/Users/hxx/Library/Caches/ms-playwright PANEL_URL=http://127.0.0.1:52103 npm run test:e2e
...
```bash
HOME=/tmp/noe-e2e-<port> PORT=<port> npm start
