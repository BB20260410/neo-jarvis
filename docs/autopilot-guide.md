...
- 日志 `~/.noe-panel/autopilot-log.jsonl` 0o600 保留 1000 条
- 配置 `~/.noe-panel/autopilot.json` 0o600
...
```
任何房 error → autopilot 触发 archive 规则 → 自动 markdown 导出到 ~/Documents/noe-archive/
```
