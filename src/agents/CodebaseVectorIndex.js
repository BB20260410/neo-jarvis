...
/**
 * Builds a vector index from the provided codebase evidence map.
 *
 * @param {Object} map - The evidence map containing file data.
 * @param {Array<Object>} [map.evidence] - Array of file evidence objects to index.
 * @returns {Object} An object containing summary metadata and a `query` function.
 * @returns {Object} return.summary - Metadata about the index configuration and state.
 * @returns {Function} return.query - Function to perform semantic search against the indexed files.
 */
