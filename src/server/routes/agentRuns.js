...
import { registerAgentRunApprovalResumeRoutes } from './agentRunsApprovalResume.js';
...
function buildPatchPrompt(timeline = {}) {
  ...
  const codeQuestionCitations = Array.isArray(codeQuestion?.citations)
    ...
    : [];
  return [
    'You generate a JSON manifest for a local-first Noe idea_to_archive Agent Run.',
...
export function registerAgentRunRoutes(app, {
  ...
  registerAgentRunApprovalResumeRoutes(app, {
    agentRunStore,
    approvalStore,
