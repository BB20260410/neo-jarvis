...
export async function executeNoeSocialFinalPublish({
  ...
  if (draft.externalSideEffectPerformed) blockers.push('draft_already_has_external_side_effect'); // codex post-review: 已发布 draft 必须阻断重复 final publish（warnings 不挡 :434 osascript 点击，会重复对外发布）
