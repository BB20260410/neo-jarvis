...
export const NOE_OPTIONAL_POST_REVIEW_MODELS = Object.freeze(['xiaomi']);
...
export function validateNoePostReviewPack(pack = {}, {
  ...
  if (/sk-[A-Za-z0-9_-]{20,}|tp-[A-Za-z0-9._~+/=-]{20,}|Authorization:\s*Bearer\s+(?!\[redacted\])[A-Za-z0-9._~+/=-]{8,}/.test(serialized)) {
