...
// owner 2026-07-22：云端优先 Grok 4.5（xai），其后 highspeed/codex/claude 等；本地 lmstudio 仅作链尾兜底（见 resolveForegroundChatChain）。
export const DEFAULT_CLOUD_CHAT_CHAIN = Object.freeze(['xai', 'minimax-highspeed', 'minimax', 'codex', 'claude', 'gemini', 'gemini-openai', 'gemini-cli', 'litellm']);
