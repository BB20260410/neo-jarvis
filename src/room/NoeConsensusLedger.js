...
const SECRET_PATTERNS = [
  { pattern: /(MINIMAX_API_KEY|OBSIDIAN_API_KEY|OPENAI_API_KEY|XIAOMI_API_KEY)\s*[:=]\s*["']?[^"'\s]+/gi, replacement: '$1=[redacted]' },
  { pattern: /(Authorization:\s*Bearer\s+)(?!<api-key>)[A-Za-z0-9._~+/=-]{8,}/gi, replacement: '$1[redacted]' },
  { pattern: /(X-Panel-Owner-Token["':\s]+)[0-9a-f]{32,}/gi, replacement: '$1[redacted]' },
  { pattern: /sk-[A-Za-z0-9_-]{20,}/g, replacement: '[redacted-openai-key]' },
  { pattern: /tp-[A-Za-z0-9._~+/=-]{20,}/g, replacement: '[redacted-xiaomi-key]' },
  { pattern: /\?t=[0-9a-f]{32,}/gi, replacement: '?t=[redacted]' },
];
export const NOE_CONSENSUS_REDACTION_POLICY_SUMMARY = Object.freeze([
  'provider_env_assignment: MINIMAX_API_KEY / OBSIDIAN_API_KEY / OPENAI_API_KEY / XIAOMI_API_KEY',
