...
//
// 数据流：
//   启动期 load() → 扫 src/plugin/builtin/*.json + ~/.noe-panel/cli-plugins/*.json
...
const USER_DIR = join(homedir(), '.noe-panel', 'cli-plugins');
...
export class PluginRegistry {
  ...
  /** 安装用户 plugin manifest（落盘到 ~/.noe-panel/cli-plugins/<id>.json） */
  install(manifest) {
    // 校 schema 先
