...
describe('noe voice ear acceptance helpers', () => {
  ...
  it('renders reports without token fields and keeps owner review pending', () => {
    const report = {
      ...
      profileId: 'default',
      reportFile: '/Users/hxx/Desktop/Neo 贾维斯/output/noe-voice-ear-acceptance/demo/report.json',
      outDir: '/Users/hxx/Desktop/Neo 贾维斯/output/noe-voice-ear-acceptance/demo',
